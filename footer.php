...
<section
      class="bg-color"
    >
          <div class="footer-one color-white">
            <div class="container">
              <div class="inner-wrapper">
                <div class="row">
                  ...
                  <div class="col-lg-2 col-md-4 col-5 mb-20">
                    <h5 class="footer-title mb-10">Browse by skill</h5>
                    <ul class="footer-nav-link style-none">
                  ...
                  <div class="col-lg-3 mb-20 footer-newsletter">
                    <h5 class="footer-title mb-10">Contact</h5>
                    <div
                      class="address border-bottom d-flex justify-content-lg-start align-items-center mt-5 pb-5"
                    >
                      <i class="fa-solid mr-10 fa-location-dot fa-xl"></i>
                      <span> 210 N 1200 E Ste 200 Lehi, UT 84043 </span>
                    </div>
                    <div
                      class="phone border-bottom d-flex justify-content-lg-start align-items-center mt-5 pb-5"
                    >
                      <i
                        class="fa-sharp fa-solid mr-10 fa-xl fa-phone fa-rotate-270"
                      ></i>
                      <span> (801) 331-8770 </span>
                    </div>
                    <div
          ...
          <!-- /.footer-one -->
          <div class="container-fluid bg-black p-25">
